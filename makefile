...
PVU_SOFTPOSIT_REFERENCE_TESTS := $(CONFIG_PVU_PROTOCOL_REGRESSION) $(CONFIG_PVU_MAC_REGRESSION) $(CONFIG_RESNET_POSIT32_TO_FP4) $(CONFIG_RESNET_POSIT32_TO_FP8) $(CONFIG_RESNET_POSIT32_TO_FP16) $(CONFIG_RESNET_POSIT32_TO_FP32)
