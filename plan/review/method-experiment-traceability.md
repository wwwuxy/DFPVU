...
| Implementation compactness and energy boundary | Clock-bound OpenROAD PPA baseline and four-`vmfpu` Ara cost boundary | DFPVU and Ara VMFPU4 Nangate45 synthesis/floorplan/screening-CTS records | Report raw mapped cells and area under the matched library/clock/utilization policy; do not report normalized area, power, energy, or frequency superiority | Raw hardware-cost evidence available; normalized claim deferred |
