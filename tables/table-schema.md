...
| DFPVU implementation cost | Make the physical-design boundary auditable | One clock-bound DFPVU configuration; optional matched Ara row | target period, mapped cells/area, core/die area, utilization, CTS status, wire/via metrics, DRC, vectorless power assumptions | `openroad/clock_bound_7p5ns/` OpenROAD reports |
